...
const Login = () => {
  ...
  useEffect(() => {
    // Show error message if redirected with an error
...
const handleSubmit = async (e) => {
    ...
    try {
        await login({ email: formData.email, password: formData.password }); // Pass object
  ...
  return (
    <div className="container">
      <div className="logo-container">
        <img src={logo} alt="Eco-Saathi" className="logo" />
      </div>
